...
public class Ticket {
    ...
    @OneToOne
    @JoinColumn(name = "departure_baggage_id", referencedColumnName = "id_baggage")
    private Baggage departureBaggage;
    @OneToOne
    @JoinColumn(name = "return_baggage_id", referencedColumnName = "id_baggage")
    private Baggage returnBaggage;

    private Timestamp createdAt;

    public Ticket(Customer customer, Trip trip,
            Flights_Seat departureSeat, Flights_Seat returnSeat,
            Long price, Baggage departureBaggage, Baggage returnBaggage) {
